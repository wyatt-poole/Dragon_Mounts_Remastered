...
public record DragonVariant(
        ...
        @SerializedName("inventory_texture") ResourceLocation inventoryTexture,
        @SerializedName("model_location") ResourceLocation modelLocation,
        @SerializedName("animation_location") ResourceLocation animationLocation,
